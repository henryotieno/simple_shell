...
/**
 * get_history_file - finds the file
 * @info: par structure
 * Return: assigned string with history file
 */
...
/**
 * build_history_list - entry inserter
 * @buf: buffer
 * @info: args container
...
/**
 * renumber_history - history renumbering
 * @info: args container
